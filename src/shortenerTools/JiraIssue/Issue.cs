    ...
    public static class Issue
    {
            ...
            ILogger log)
        {
            ...
            var redirectUrl = val3 == null 
                ...
                : $"https://chromehearts.atlassian.net/servicedesk/customer/portal/7/group/28/create/144?customfield_10638={val1}&customfield_10639={val2}&summary=Issue%20with%20{val3}";
